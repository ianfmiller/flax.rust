...
panel.C<-load.image("~/Documents/GitHub/flax.rust/cross.scale.transmission.dynamics/figs/figure.1.files/B.jpg")
plot(panel.C,axes=F)
...
panel.D<-load.image("~/Documents/GitHub/flax.rust/cross.scale.transmission.dynamics/figs/figure.1.files/C.jpg")
plot(panel.D,axes=F)
...
panel.E<-load.image("~/Documents/GitHub/flax.rust/cross.scale.transmission.dynamics/figs/figure.1.files/D.jpg")
plot(panel.E,axes=F)
...
panel.F<-load.image("~/Documents/GitHub/flax.rust/cross.scale.transmission.dynamics/figs/figure.1.files/E.jpg")
plot(panel.F,axes=F)
