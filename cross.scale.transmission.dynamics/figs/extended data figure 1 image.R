...
rgb_contrast = scales::rescale(rgb_array,to=c(.1,1))
...
render_label(heightmap=el_matrix,text="BT",lat=points@coords[2,2],long=points@coords[2,1],extent=e,textcolor="white",linecolor = site.cols[2],z=750,zscale=15,textsize = 2.5,linewidth = 4)
render_label(heightmap=el_matrix,text="GM",lat=points@coords[3,2],long=points@coords[3,1],extent=e,textcolor="white",linecolor = site.cols[3],z=2000,zscale=15,textsize = 2.5,linewidth = 4)
render_label(heightmap=el_matrix,text="HM",lat=points@coords[4,2],long=points@coords[4,1],extent=e,textcolor="white",linecolor = site.cols[4],z=2500,zscale=15,textsize = 2.5,linewidth = 4)

render_snapshot() #save as ~/Documents/GitHub/flax.rust/cross.scale.transmission.dynamics/figs/figure.1.files/B.jpg
# export at dimensions 940x696, then crop to minimum bounding dimensions