...
colors<-c("black",magma(100)[c(20,30,40)],magma(100)[c(70,80,90)])

plot(0,0,xlim=c(start.date,end.date),ylim=c(8,30),type="n",xlab="date",ylab="plant height",cex.axis=1,cex.lab=1.2,axes=F)
